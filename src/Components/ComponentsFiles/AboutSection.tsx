    ...
    return (
        ...
        <div className = "aboutButtons w-[1050px] h-[80px] mx-auto mt-[50px] mb-[200px] flex justify-around">
            ...
            <div className = "button">
                ...
                <div className = "buttonText text-[100%] w-[250px] items-center ml-[25px]">
                    <button> WHAT WAS THE INSPIRATION BEHIND CARD’HEURE ?</button>
                </div>
            </div>
            ...
            <div className = "button">
                <div className = "buttonCircle w-[45px] h-[45px] rounded-[50%] bg-[rgb(117,147,120)]"></div>
                <div className = "buttonText text-[75%] ml-[25px] w-[300px]">
