  ...
  return (
      <>
        <h1 className="titlePrompt h-[50px] leading-[50px] mt-[3%] w-[60%] mx-[auto] text-center text-[180%] font-extralight">
          Saisissez le titre de votre nouveau sujet ci-dessous
        </h1>

        <div className="createTitle w-[55%] h-[50px] mx-[auto] mt-[4%] flex text-[150%]" id="createTitle">
          {isTitleSaved ? (
              <h1 className="enterTitle flex border-b-[1px] border-b-[solid] border-b-[black] justify-center ml-[20%] w-[64%] h-[35px] mb-[6px] text-center font-light italic">
                {titleSave}
              </h1>
          ) : (
              <input
